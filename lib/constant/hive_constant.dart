...
const int kHiveTypeIDForAccessInfo = 8;
const int kHiveTypeIDForSaleInfo = 9;
const int kHiveTypeIDForImageLinks = 10;
const int kHiveTypeIDForPanelization = 11;
const int kHiveTypeIDForReadingModes = 12;
const int kHiveTypeIDForIndustry = 13;
